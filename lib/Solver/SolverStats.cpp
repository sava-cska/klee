...
Statistic stats::validQueriesSize("ValidQueriesSize", "UQACount");
Statistic stats::unsatCoresSize("UnsatCoresSize", "UCSize");
Statistic stats::unsatCoresCount("UnsatCoresCount", "UCCount");
