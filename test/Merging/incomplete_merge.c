...
// RUN: %klee --output-dir=%t.klee-out --execution-mode=forward --use-merge --debug-log-merge --use-incomplete-merge --debug-log-incomplete-merge --search=nurs:covnew --use-batching-search %t.bc 2>&1 | FileCheck %s
